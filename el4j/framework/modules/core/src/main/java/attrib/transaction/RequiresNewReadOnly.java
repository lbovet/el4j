...
/**
 * This class specifies a requires new read only transaction attribute.
 ...
 */
public class RequiresNewReadOnly extends DefaultTransactionAttribute {

    /**
     * Default constructor.
     */
    public RequiresNewReadOnly() {
        super(PROPAGATION_REQUIRES_NEW);
        setReadOnly(true);
    }
}