...
public class PBEncryptor {
	...
	/** Hashes the password and converts it to a suitable 
	 * format for the  cipher.
	 * @param password The password to generate a key from.
	 * @return A valid key derived from the password.
	...
	public  String encrypt(String plain) throws EncryptionException {
		...
		try {
			...
			return new String(
				   Base64.encodeBase64(ArrayUtils.addAll(salt,encBytes)));
		}
		catch ( Exception e ) {
			throw new EncryptionException(e);
		}
