...
public class StrategyIndependentTest extends AbstractTest {
	 ...
	 */
	@Test public void testKeyStrategy() {
	 ...
	 */
	@Test public void testOfflineIdentity() {
		usePersonsSmall();
	 ...
	 */
	@Test public void testOfflineServerNew() {
		usePersonsSmall();
	 ...
	 */
	@Test public void testOfflineFailOnNew() {
		usePersonsSmall();
		offlineAll();
	 ...
	 */
	@Test public void testForceRemote() {
		forceTest(false);
	 ...
	 * Also check a force on a dependent conflict fails.
	 */
	@Test public void testForceLocal() {
		forceTest(true);
	 ...
	 */
	@Test public void testDeleteResolution() {
		usePersonsSmall();
