...
import ch.elca.el4j.demos.gui.MainFormMDI;
import ch.elca.el4j.demos.jasper.gui.reporting.ReportSaver;
import ch.elca.el4j.demos.jasper.gui.reporting.ReportViewer;

/**
 * Sample MDI application that extends Thin Client its parent by adding a
 * reporting section.
 *
 * See also associated JasperMainFormMDI.properties file that
 * contains resources
 *
 ...
 */
public class JasperMainFormMDI extends MainFormMDI {
