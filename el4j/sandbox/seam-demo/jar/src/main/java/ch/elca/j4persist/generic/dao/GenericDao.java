 ...
 *   ("$URL: https://el4j.svn.sourceforge.net/svnroot/el4j/trunk/el4j/framework/modules/core/src/main/java/ch/elca/el4j/services/persistence/generic/dao/GenericDao.java $",
 *    "$Revision: 1795 $",
 *    "$Date: 2007-02-15 11:23:18 +0100 (Thu, 15 Feb 2007) $",
 *    "$Author: enylaios $"
 * );</script>
 *
 * @param <T>
