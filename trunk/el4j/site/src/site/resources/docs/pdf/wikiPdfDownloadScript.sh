...
wget -v -O  ReferenceDoc.pdf http://wiki.elca.ch/twiki/el4j/bin/genpdf/EL4J/ReferenceDoc?pdfstruct=book
...
wget -v -O  GettingStarted.pdf http://wiki.elca.ch/twiki/el4j/bin/genpdf/EL4J/GettingStarted?pdfstruct=book
wget -v -O  SetupEL4J.pdf http://wiki.elca.ch/twiki/el4j/bin/genpdf/EL4J/SetupEL4J?pdfstruct=book
