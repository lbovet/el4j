...
/**
 * The interceptor to be invoked if an ExampleAnnotation on a class is set.
 * 
 ...
 */
public class ExampleClassInterceptor implements MethodInterceptor,
    ...
    protected static Log s_logger = LogFactory
            .getLog(ExampleClassInterceptor.class);
    ...
    public Object invoke(MethodInvocation methodInvocation) throws Throwable {
         ...
         *  The targetClass given as argument twice, because the parameter 
         *  target can be other types (e.g. Field, Constructor).
         */
        Collection annotations = m_metaDataCollector.getMetaData(targetClass, 
            ElementType.TYPE, targetClass);
