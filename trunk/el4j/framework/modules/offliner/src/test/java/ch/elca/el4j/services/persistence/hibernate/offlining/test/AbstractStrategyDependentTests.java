...
public abstract class AbstractStrategyDependentTests extends AbstractTest {
	 ...
	 */
	@Test public void testOfflineAndCommit() {
		usePersons();
		offlineAll();
	 ...
	 */
	@Test public void testModification() {
		usePersons();
		offlineAll();
		m_offliner.setOnline(false);
		assertFalse(m_offliner.isOnline());
	 ...
	 */
	@Test public void testCreateOffline() {
		m_offliner.setOnline(false);
	 ...
	 * DON'T EVER DO THIS !
	 */
	@Test public void testWrongDeleteOrder() {
		/*
		 * Alice <-- Eve
		 */
		Person alice = Person.create();
	 ...
	 */
	@Test public void testConcurrentFailure() {
		usePersons();
	 ...
	 */
	@Test public void testDependentConflict() {
		// Bob <- Alice <- Eve
		//        ^ conflict
	 ...
	 */
	@Test public void testServerVersion() {
		usePersons();
	 ...
	 */
	@Test public void testMultipleSync() {
		usePersons();
		offlineAll();
		Conflict[] conflicts = m_offliner.synchronize();
		assertEquals(0, conflicts.length);
