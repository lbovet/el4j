 ...
 * 
 * We would like to be able to perform dao operations on an object whose type
 ...
 */
public final class TotallyGenericDaoUtility {

	/** Utility class. */
	private TotallyGenericDaoUtility() { }
	
	/**
	 * Get the actual dao. Any extra things that need to be done are done here.
	 * @param reg The dao registry.
