...
/**
 * A TcpInterruptor represents a service intended to interrupt TCP traffic 
 ...
 * connect on the interruptor's port.  
 * 
 ...
 */
public class TcpInterruptor implements Runnable {
    ...
    /**
     * Creates a new TcpInterruptor that listens on port <code>listenport</code>
     ...
     *            Forwarding port
     */
    public TcpInterruptor(int listenport, int targetport) {
     ...
     */
    public TcpInterruptor(int port, SocketAddress target) {
        m_port = port;
        m_target = target;
    ...
    static class Receiver extends Thread {
        ...
        TcpMsg receive() throws ClosedChannelException {
            try {
                m_buf.clear();
         ...
         * @param msg Message to print.
         */
        protected void process(TcpMsg msg) {
