...
public class ApplicationLauncher {
    ...
    protected ApplicationContext loadStartupContext(String startupContextPath) {
        ...
        try {
            if (StringUtils.hasText(startupContextPath)) {
            	ApplicationContext ac = new ModuleApplicationContext(startupContextPath, false);
                return ac;
            }
        } catch (Exception e) {
    ...
    private void launchMyRichClient() {  	
        ...
        s_applicationContext = m_rootApplicationContext;
         ...
         */
        try {
            Class<GUIApplication> applicationClass = m_rootApplicationContext
                .getType(APPLICATION_BEAN_ID);
            //application.openWindow(application.getLifecycleAdvisor()
            //    .getStartingPageId());
            //application.getLifecycleAdvisor().onPostStartup();
            
            GUIApplication.setSpringContext(m_rootApplicationContext);
            
            PlasticLookAndFeel.setPlasticTheme(new ExperienceBlue());
            GUIApplication.launch(applicationClass, new String[]{});
     ...
     * 
     * @param beanFactory
     *            Is the bean factory where to get the splash screen bean.
     */
    ...
    /**
     * Very ugly method. Used as temporary fix to get app ctxt
