...
import ch.elca.el4j.internal.apps.service.MailEngine;
...
//    }
    ...
    /**
     * Reads parameter value (must be an Integer) of parameter with name paramName
     * @param event
     * @return
     */
    protected Integer getIntKeyFromParam(FacesEvent event, String paramName){
        /*
         * get session from External Context
         */
         ...
         * search UIParameter
         */
        UIParameter component = (UIParameter) event.getComponent().findComponent(paramName);

        /*
         * parse value of UIParameter
         */
        return Integer.parseInt(component.getValue().toString());
