 ...
 *   ("$URL: https://el4j.svn.sourceforge.net/svnroot/el4j/trunk/el4j/maven/plugins/maven-database-plugin/src/main/java/ch/elca/el4j/plugins/database/mojo/CleanUpDatabaseMojo.java $",
 *    "$Revision: 1864 $",
 *    "$Date: 2007-07-22 23:05:48 +0200 (So, 22 Jul 2007) $",
 *    "$Author: poser55 $"
 * );</script>
 * 
 * @goal cleanUp
 ...
 */
public class CleanUpMojo extends AbstractDBExecutionMojo {
