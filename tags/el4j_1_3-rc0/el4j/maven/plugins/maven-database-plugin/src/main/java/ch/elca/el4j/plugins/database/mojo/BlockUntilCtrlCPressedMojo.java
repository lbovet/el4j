 ...
 *   ("$URL: https://el4j.svn.sourceforge.net/svnroot/el4j/trunk/el4j/maven/plugins/maven-database-plugin/src/main/java/ch/elca/el4j/plugins/database/mojo/StartMojo.java $",
 *    "$Revision: 1692 $",
 *    "$Date: 2007-01-16 15:20:35 +0100 (Tue, 16 Jan 2007) $",
 *    "$Author: enylaios $"
 * );</script>
 * 
 * @goal block
