 ...
 * within this unchecked exception.<br>
 ...
 * of the wrapped exception, not the one of the current WrapperRTException
 * instance. For instance if A wraps B (A is of a class inheriting
 * WrapperRTException), a call to <code>printStackTrace</code> on A will give:
 * <br>
 ...
 * normal (checked) exception
 */
public class WrapperRTException extends RuntimeException {
     ...
     * deserialized without losing the stacktrace (important for Java <1.4).<br>
     * If no wrapped exception is provided, the own stacktrace of the current
     * instance is saved in an internal field.
     *
     * @param message a <code>String</code> value
     * @param wrappedException a <code>Throwable</code> value, Warning :
     *  wrappedException may be null if the second constructor of
     *  BaseRTException is called !
     */
    public WrapperRTException(String message, Throwable wrappedException) {
        super(message);
     ...
     */
    public WrapperRTException(Throwable wrappedException) {
