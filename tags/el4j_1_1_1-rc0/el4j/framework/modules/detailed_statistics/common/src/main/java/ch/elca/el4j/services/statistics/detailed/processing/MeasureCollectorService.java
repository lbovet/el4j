 ...
 * the LEAF SharedContext object (keys defined by <code>CONTEXT_NAME_ID</code>
...
public interface MeasureCollectorService {
    ...
    /** SharedContext key for saving the measure MeasureID object. */
    public static final String CONTEXT_NAME_ID = "MEASURE_ID";

    /** SharedContext key for saving the measure sequence. */
