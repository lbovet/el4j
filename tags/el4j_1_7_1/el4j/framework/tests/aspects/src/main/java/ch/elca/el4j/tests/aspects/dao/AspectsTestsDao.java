 ...
 */
package ch.elca.el4j.tests.aspects.dao;
...
/**
 * Dao interface for domain object {@link AspectsTests}.
 *
 * @svnLink $Revision$;$Date$;$Author$;$URL$
 *
 * @author Martin Zeltner (MZE)
 */
public interface AspectsTestsDao
	extends ConvenienceGenericHibernateDao<AspectsTests, Integer> { }
