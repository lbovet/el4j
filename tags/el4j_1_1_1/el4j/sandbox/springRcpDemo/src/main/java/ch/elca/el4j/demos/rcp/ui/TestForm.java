...
import ch.elca.el4j.demos.rcp.ui.MasterDetailForm.DetailForm;
 ...
 */
public class TestForm extends AbstractForm implements ListSelectionListener{

    private DetailForm m_test;
     ...
     */
    public TestForm(HierarchicalFormModel formModel, String property, DetailForm test) {
        super(formModel);
        m_property = property;
        m_test = test;
    }
    ...
    protected JComponent createFormControl() {
        ...
        JList m_list = getComponentFactory().createList();
    ...
    public void valueChanged(ListSelectionEvent e) {
        ValueModel o = (ValueModel) m_test.getFormModel().getValueModel(m_property);
        ValueHolder allNodesHolder = new ValueHolder(o.getValue());
