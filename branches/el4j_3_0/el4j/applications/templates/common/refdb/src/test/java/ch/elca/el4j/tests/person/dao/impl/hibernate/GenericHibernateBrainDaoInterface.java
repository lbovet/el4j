 ...
 * {@link BrainDao} and {@link ConvenienceGenericHibernateDao} methods. 
 *
 * @svnLink $Revision$;$Date$;$Author$;$URL$
 *
 * @author Jonas Hauenstein (JHN)
 */
public interface GenericHibernateBrainDaoInterface 
	extends ConvenienceGenericHibernateDao<Brain, Integer> {
