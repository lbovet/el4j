 ...
 */
public class DefaultHierarchyRepositoryChangeNotifier<T>
        extends DefaultRepositoryChangeNotifier
        implements HierarchyRepositoryChangeNotifier {
     ...
     */
    public DefaultHierarchyRepositoryChangeNotifier(Class<T> responsibility) {
