 ...
 * 
 * @version $Id: Orion2xInstalledLocalContainer.java 1000 2006-04-09 15:00:57Z vmassol $
 */
public class Orion2xInstalledLocalContainer extends AbstractOrionInstalledLocalContainer
{
    /**
     * Unique container id.
     */
    public static final String ID = "orion2x";
     ...
     */
    public Orion2xInstalledLocalContainer(LocalConfiguration configuration)
    {
        super(configuration);
    }
